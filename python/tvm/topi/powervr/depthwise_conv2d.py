...
"""depthwise_conv2d schedule on Imagination PowerVR GPU"""
...
@autotvm.register_topi_compute("depthwise_conv2d_nchw.powervr")
...
@autotvm.register_topi_schedule("depthwise_conv2d_nchw.powervr")
    ...
    def _schedule(pad_data, kernel, conv):
        ...
        if cfg.is_fallback:
            ref_log = autotvm.tophub.load_reference_log(
                "powervr", "v9h", "depthwise_conv2d_nchw.powervr"
            )
